...
@media (min-width: 576px) {
    ...
    body {
        font-size: 12px; /* Exemple de modification de la taille de la police */
    }

    .container {
        max-width: 576px; /* Exemple de modification de la largeur maximale de la container */
        margin: 0 auto; /* Centrer la container */
    }

    .navbar {
        height: 50px; /* Exemple de modification de la hauteur de la navbar */
    }

    .navbar-brand {
        font-size: 16px; /* Exemple de modification de la taille de la police du brand */
    }

    .navbar-nav .nav-item {
        margin-bottom: 4px; /* Exemple de modification de la marge entre les éléments de la navbar */
    }
...
@media (min-width: 768px) {
    ...
    body {
        font-size: 14px; /* Exemple de modification de la taille de la police */
        background-color: #f8f9fa; /* Exemple de modification de la couleur de fond */
    }

    .container {
        max-width: 768px; /* Exemple de modification de la largeur maximale de la container */
        margin: 0 auto; /* Centrer la container */
    }

    .navbar {
        height: 60px; /* Exemple de modification de la hauteur de la navbar */
    }

    .navbar-brand {
        font-size: 18px; /* Exemple de modification de la taille de la police du brand */
    }

    .navbar-nav .nav-item {
        margin-bottom: 6px; /* Exemple de modification de la marge entre les éléments de la navbar */
    }
...
@media (min-width: 992px) {
    ...
    body {
        font-size: 16px; /* Exemple de modification de la taille de la police */
        background-color: #f8f9fa; /* Exemple de modification de la couleur de fond */
    }

    .container {
        max-width: 1100px; /* Exemple de modification de la largeur maximale de la container */
        margin: 0 auto; /* Centrer la container */
    }

    .navbar {
        height: 70px; /* Exemple de modification de la hauteur de la navbar */
    }

    .navbar-brand {
        font-size: 20px; /* Exemple de modification de la taille de la police du brand */
    }

    .navbar-nav .nav-item {
        margin-bottom: 8px; /* Exemple de modification de la marge entre les éléments de la navbar */
    }
...
@media (min-width: 1200px) {
    ...
    body {
        font-size: 18px; /* Exemple de modification de la taille de la police */
        background-color: #f8f9fa; /* Exemple de modification de la couleur de fond */
    }

    .container {
        max-width: 1300px; /* Exemple de modification de la largeur maximale de la container */
        margin: 0 auto; /* Centrer la container */
    }

    .navbar {
        height: 80px; /* Exemple de modification de la hauteur de la navbar */
    }

    .navbar-brand {
        font-size: 24px; /* Exemple de modification de la taille de la police du brand */
    }

    .navbar-nav .nav-item {
        margin-bottom: 10px; /* Exemple de modification de la marge entre les éléments de la navbar */
    }
