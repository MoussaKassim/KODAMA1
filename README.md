...
<head>
    ...
    <style>
        ...
        .navbar {
            ...
            padding: 0; /* Réduit la hauteur de la barre noire et ajoute un peu de padding */
        }
        ...
        #sidebar {
            position: fixed;
            top: 50px; /* Ajustez la valeur pour positionner le carré à 50px du haut de la page */
            bottom: 2cm; /* Ajustez la valeur pour positionner le carré à 2 cm du bas de la page */
            left: 20px; /* Place le carré à 20px du bord gauche */
            width: 200px; /* Largeur du carré */
            height: calc(100vh - 50px); /* Hauteur automatique pour s'adapter à la hauteur de la fenêtre */
            ...
            background-color: #ffffff; /* Couleur de fond du sidebar */
        }
        ...
        /* Main Content Styles */
        .container {
            margin-left: 250px; /* Ajoute un espacement à gauche pour éviter le chevauchement avec le menu latéral */
        }
